...
urlpatterns = [
    ...
    path("status/<str:stand_ym>/", views.work_status, name="work_status"),
    # path("status/late/", views.work_status_late, name="work_status_late"),
    # path("status/late/<str:stand_ym>/", views.work_status_late, name="work_status_late"),
    # path("status/early/", views.work_status_early, name="work_status_early"),
    # path("status/early/<str:stand_ym>/", views.work_status_early, name="work_status_early"),
    # path("status/overtime/", views.work_status_overtime, name="work_status_overtime"),
    # path("status/overtime/<str:stand_ym>/", views.work_status_overtime, name="work_status_overtime"),
    # path("status/holiday/", views.work_status_holiday, name="work_status_holiday"),
    # path("status/holiday/<str:stand_ym>/", views.work_status_holiday, name="work_status_holiday"),
